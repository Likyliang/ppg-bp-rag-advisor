---
source_id: park_2022_ppg_analysis_applications_integrative_review
...
language: en
url: https://www.frontiersin.org/journals/physiology/articles/10.3389/fphys.2021.808451/full
...
source_hash: 9cc081462b2ff036
safety_level: standard
---

## 来源摘要

该整合综述覆盖 PPG 波形分析、噪声处理、特征提取、临床与可穿戴应用，可支持本系统解释 PPG 信号质量和算法边界。

## 可用于报告的要点

- PPG 分析依赖波形质量、噪声控制、特征提取和应用场景。
- 报告可用该来源说明低质量 PPG 不适合强解释，应重新采集或用规范设备复核。
- 综述不能作为血压诊断或设备准确性保证。
...
- 已从 Frontiers/PMC 合法公开入口归档 PDF；本项目只提交中文摘要、citation 和访问记录，不提交全文 PDF。
- 该综述支持 PPG 分析依赖波形质量、噪声控制、特征提取和应用场景。
- 报告可用该来源说明低质量 PPG 不适合强解释，应重新采集或用规范设备复核；不得作为血压诊断依据。
